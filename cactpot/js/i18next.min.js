...
!(function () {
  ...
  function f(a, b) {
    "function" == typeof a && ((b = a), (a = {})),
      ...
      (L = T.toLanguages(P.lng)),
      (F = L[0]),
      T.log("currentLng set to: " + F),
      P.useCookie &&
        T.cookie.read(P.cookieName) !== F &&
        T.cookie.create(
          P.cookieName,
          F,
      ...
      P.detectLngFromLocalStorage &&
        ...
        window.localStorage &&
        T.localStorage.setItem("i18next_lng", F);
    var c = z;
    a.fixLng &&
      ((c = function (a, b) {
  ...
  function h(a, b, c, d) {
    "string" != typeof b
      ...
      (J[a] = J[a] || {}),
      (J[a][b] = J[a][b] || {}),
      d ? T.deepExtend(J[a][b], c) : T.extend(J[a][b], c);
  }
  function i(a, b) {
  ...
  function k(a, b, c, d) {
    "string" != typeof b
      ...
      (J[a] = J[a] || {}),
      (J[a][b] = J[a][b] || {});
    for (var e = c.split(P.keyseparator), f = 0, g = J[a][b]; e[f]; )
      f == e.length - 1
        ? (g[e[f]] = d)
  ...
  function o(a, b) {
    ...
    j.length
      ? I.sync._fetch(j, c, function (c, d) {
            ...
            P.ns.namespaces.indexOf(c) < 0 && P.ns.namespaces.push(c),
              T.each(j, function (a, f) {
                (J[f] = J[f] || {}),
                  ...
                  0 === e &&
                    b &&
                    (P.useLocalStorage && I.sync._storeLocal(J), b());
              });
          });
        })
      : b && b();
      ...
      if (0 !== b.length) {
        ...
        if ("html" === d)
          (f = P.defaultValueFromContent
            ? H.extend({ defaultValue: a.html() }, c)
            : c),
            a.html(H.t(b, f));
        else if ("text" === d)
          (f = P.defaultValueFromContent
            ? H.extend({ defaultValue: a.text() }, c)
            : c),
            a.text(H.t(b, f));
        else if ("prepend" === d)
          (f = P.defaultValueFromContent
          ...
          f = P.defaultValueFromContent
            ? H.extend({ defaultValue: a.data(g) }, c)
            : c;
          var h = H.t(b, f);
          a.data(g, h), a.attr(d, h);
        } else
          (f = P.defaultValueFromContent
            ? H.extend({ defaultValue: a.attr(d) }, c)
            : c),
            a.attr(d, H.t(b, f));
      }
    }
  ...
  function u(a, b) {
    ...
    for (
      ...
      -1 != a.indexOf(P.reusePrefix) && (K++, !(K > P.maxRecursion));
  ...
  function C(a, b) {
    ...
    var c = a[0];
    if (a.length > 1)
      for (var d = 0; d < a.length && ((c = a[d]), !y(c, b)); d++);
    var e,
      f = A(c, b),
      g = D(c, b),
      h = b.lng ? T.toLanguages(b.lng, b.fallbackLng) : L,
    ...
    if (
      ...
      void 0 === g && ((f = t(f, b)), (f = u(f, b)), j && X[j]))
    ) {
      var l = A(c, b);
      g = X[j](l, c, b);
    }
  ...
  function D(a, b) {
    ...
    if (
      (b.lngs && (f = b.lngs),
      b.lng && ((f = T.toLanguages(b.lng, b.fallbackLng)), !J[f[0]]))
    ) {
      var g = P.getAsync;
      (P.getAsync = !1),
        I.sync.load(f, P, function (a, b) {
    ...
    if (v(b)) {
      ...
      if (((d = z(j, c)), d != P.contextNotFound))
        return t(d, { context: b.context });
    }
    if (w(b, f[0])) {
    ...
    if (x(b)) {
      ...
      var o =
        ...
        P.nsseparator +
        a +
        ((b.count && !w(b, f[0])) || !b.count ? P.indefiniteSuffix : "");
    ...
    for (
      ...
      for (var y = f[r], B = 0, E = J[y] && J[y][h]; q[B]; )
        (E = E && E[q[B]]), B++;
      if (void 0 !== E) {
        var F = Object.prototype.toString.apply(E);
        if ("string" == typeof E) (E = t(E, b)), (E = u(E, b));
        else if (
          "[object Array]" !== F ||
          P.returnObjectTrees ||
          b.returnObjectTrees
        ) {
          if (null === E && P.fallbackOnNull === !0) E = void 0;
          else if (null !== E)
            if (P.returnObjectTrees || b.returnObjectTrees) {
              ...
              "function" == typeof P.objectTreeKeyHandler
                ? (E = P.objectTreeKeyHandler(a, E, y, h, b))
                : ((E =
                    "key '" +
                    h +
                    ":" +
    ...
    if (
      ...
      if (((b.isFallbackLookup = !0), P.fallbackNS.length)) {
        for (var H = 0, K = P.fallbackNS.length; K > H; H++)
          if (
            ((p = D(P.fallbackNS[H] + P.nsseparator + a, b)),
            p || ("" === p && P.fallbackOnEmpty === !1))
          ) {
            var M =
                p.indexOf(P.nsseparator) > -1 ? p.split(P.nsseparator)[1] : p,
  ...
  function E() {
    ...
    if (
      (P.detectLngFromLocalStorage &&
        "undefined" != typeof window &&
        window.localStorage &&
        c.push(window.localStorage.getItem("i18next_lng")),
  ...
  N = {
    load: function (a, b, c) {
      b.useLocalStorage
        ? N._loadLocal(a, b, function (d, e) {
            for (var f = [], g = 0, h = a.length; h > g; g++)
              e[a[g]] || f.push(a[g]);
            f.length > 0
              ? N._fetch(f, b, function (a, b) {
    ...
    postMissing: function (a, b, c, d, e) {
      ...
      if ("fallback" === P.sendMissingTo && P.fallbackLng[0] !== !1)
        ...
        g.push({ lng: a, url: t(P.resPostPath, { lng: a, ns: b }) });
      else if ("all" === P.sendMissingTo)
        for (var h = 0, i = e.length; i > h; h++)
          g.push({ lng: e[h], url: t(P.resPostPath, { lng: e[h], ns: b }) });
      for (var j = 0, k = g.length; k > j; j++) {
        ...
        T.ajax({
          ...
          success: function () {
            ...
            for (var a = c.split("."), e = 0, f = J[l.lng][b]; a[e]; )
  ...
  Y("sprintf", function (a, b, c) {
    ...
    (I.setLng = p),
    (I.preload = g),
    (I.addResourceBundle = h),
    (I.hasResourceBundle = i),
    (I.addResource = k),
    (I.addResources = l),
    (I.removeResourceBundle = j),
    (I.loadNamespace = n),
    (I.loadNamespaces = o),
    (I.setDefaultNamespace = m),
    (I.t = z),
    (I.translate = z),
    (I.exists = y),
    (I.detectLanguage = T.detectLanguage),
    (I.pluralExtensions = W),
    (I.sync = N),
    (I.functions = T),
    (I.lng = q),
    (I.addPostProcessor = Y),
    (I.options = P);
})();
